...
- **Next:** streak logic (hardcoded `streakDays={12}` in TodayPage), unbuilt Phase 3 leftovers (recurring tasks + manual fixed blocks). Security TODO: encrypt stored Google tokens; rotate Atlas password.
