...
- **Next: Phase 4 (part 3)** — Google Calendar → fixed blocks (needs Google Cloud OAuth credentials; user is doing guided setup). Plus streak logic, and unbuilt Phase 3 leftovers: recurring tasks + manual fixed blocks.
